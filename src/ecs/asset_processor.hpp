...
namespace foundation {
    ...
    struct AssetProcessor {
        ...
        static auto process_mesh(const ProcessMeshInfo& info, bool disable_nanite_lods = false) -> ProcessedMeshInfo;
        static void convert_gltf_to_binary(const std::filesystem::path& input_path, const std::filesystem::path& output_path, bool disable_nanite_lods = false);
