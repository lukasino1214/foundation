...
namespace foundation {
    void ScriptingEngine::init_script(ScriptComponent* script, Entity entity, const std::filesystem::path& path) {
        ...
        lua->new_usertype<NativeWIndow>("Window",
            "key_pressed", &NativeWIndow::key_pressed,
            "key_just_pressed", &NativeWIndow::key_just_pressed,
            "key_just_released", &NativeWIndow::key_just_released,
            "button_pressed", &NativeWIndow::button_pressed,
            "button_just_pressed", &NativeWIndow::button_just_pressed,
            "button_just_released", &NativeWIndow::button_just_released,
            "get_cursor_x", &NativeWIndow::get_cursor_x,
            "get_cursor_y", &NativeWIndow::get_cursor_y,
            "get_cursor_change_x", &NativeWIndow::get_cursor_change_x,
            "get_cursor_change_y", &NativeWIndow::get_cursor_change_y,
            "is_cursor_over_window", &NativeWIndow::is_cursor_over_window,
            "capture_cursor", &NativeWIndow::capture_cursor,
            "release_cursor", &NativeWIndow::release_cursor,
            "is_cursor_captured", &NativeWIndow::is_cursor_captured,
            "is_focused", &NativeWIndow::is_focused,
            "set_width", &NativeWIndow::set_width,
            "set_height", &NativeWIndow::set_height,
            "get_width", &NativeWIndow::get_width,
            "get_height", &NativeWIndow::get_height
        );
